...
server {
    listen 80;
    listen [::]:80;
    server_name nextcloud.campeoltoni.fr www.nextcloud.campeoltoni.fr;
    # enforce https
...
server {
    ...
    ssl_certificate /etc/letsencrypt/live/nextcloud.campeoltoni.fr/fullchain.pem;
    ssl_certificate_key /etc/letsencrypt/live/nextcloud.campeoltoni.fr/privkey.pem;
